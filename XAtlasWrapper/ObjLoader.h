...
extern "C"
{
    ...
    XATLAS_WRAPPER_API BOOL ObjLoader_GetMeshIndices(int mesh_index, unsigned int* iIndices, int count);
    ...
    XATLAS_WRAPPER_API int ObjLoader_GetMeshMateral(int mesh_index, int index);
